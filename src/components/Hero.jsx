      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="max-w-xl">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <a
              href="#"
              className="bg-orange-500 hover:bg-orange-600 text-black font-bold px-8 py-4 rounded-full transition-transform transform hover:scale-105 shadow-xl shadow-orange-500/30"
            >
              Get Started
            </a>
            <a
